...
GEMINI_API_KEY = "AIzaSyDGqWNHk2t_D6yHZQygQVlz27ktWJUGZyU"
...
analisis_soal = [
    # SOAL 1-35 (Dikutip dari input Anda)
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Membuat tabel/voting online untuk melihat tanggal mana yang paling banyak dipilih.", "bobot": {"SIKC": 80, "RPL": 60, "TRK": 30, "TI": 50}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "C": {"text": "Si Manajer: Membagi tugas, mencatat deadline, dan memastikan semua berjalan.", "bobot": {"SIKC": 80, "RPL": 50, "TRK": 30, "TI": 50}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Mendesain aplikasi pre-order makanan agar bisa dipesan dari kelas.", "bobot": {"SIKC": 60, "RPL": 80, "TRK": 40, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Mengelompokkan berdasarkan genre/kategori, lalu diurutkan abjad.", "bobot": {"SIKC": 80, "RPL": 50, "TRK": 40, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Statistik stamina dan akurasi operan setiap pemain.", "bobot": {"SIKC": 80, "RPL": 40, "TRK": 35, "TI": 50}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Pusat komando yang mengintegrasikan data banjir, macet, dan sampah real-time.", "bobot": {"SIKC": 80, "RPL": 50, "TRK": 40, "TI": 50}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Mencari pola: di pelajaran apa aku lemah dan kenapa (kurang tidur/kurang latihan)?", "bobot": {"SIKC": 80, "RPL": 60, "TRK": 40, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Membuat Google Form yang otomatis masuk ke Excel/Spreadsheet.", "bobot": {"SIKC": 80, "RPL": 70, "TRK": 40, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Harta karun informasi untuk memprediksi masa depan.", "bobot": {"SIKC": 80, "RPL": 50, "TRK": 30, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Memasang chip pelacak di setiap buku.", "bobot": {"SIKC": 50, "RPL": 40, "TRK": 80, "TI": 60}},
            "B": {"text": "Membuat sistem peminjaman digital yang ketat (scan barcode).", "bobot": {"SIKC": 80, "RPL": 75, "TRK": 50, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Melakukan survei, wawancara, dan menyimpulkan hasil.", "bobot": {"SIKC": 80, "RPL": 40, "TRK": 30, "TI": 50}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Menganalisis rating bintang dan membaca pola review pembeli.", "bobot": {"SIKC": 80, "RPL": 50, "TRK": 30, "TI": 50}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Grafik kenaikan atau penurunan prestasi per semester.", "bobot": {"SIKC": 80, "RPL": 50, "TRK": 30, "TI": 50}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "C": {"text": "Alur antreannya salah, harusnya dipisah antara belanjaan sedikit dan banyak.", "bobot": {"SIKC": 80, "RPL": 60, "TRK": 40, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Data dan fakta yang disampaikan valid serta terstruktur.", "bobot": {"SIKC": 80, "RPL": 40, "TRK": 30, "TI": 50}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Seksi Perlengkapan: Mengurus listrik dan tenda.", "bobot": {"SIKC": 30, "RPL": 30, "TRK": 80, "TI": 50}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Alat untuk mengolah data keuangan dan karyawan.", "bobot": {"SIKC": 80, "RPL": 50, "TRK": 40, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Mengutak-atik kabel modem siapa tahu kendor.", "bobot": {"SIKC": 40, "RPL": 40, "TRK": 80, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Menganalisis dari mana asal sampah (hulu sungai) dan mengedukasi warga.", "bobot": {"SIKC": 80, "RPL": 40, "TRK": 40, "TI": 60}},
            "C": {"text": "Membuat aplikasi pelaporan 'Buang Sampah Sembarangan'.", "bobot": {"SIKC": 60, "RPL": 80, "TRK": 40, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Mengelompokkan daftar belanjaan sesuai letak kios (Sayur, Daging, Bumbu).", "bobot": {"SIKC": 80, "RPL": 60, "TRK": 40, "TI": 50}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Bagaimana cara coding agar akurasinya tinggi.", "bobot": {"SIKC": 60, "RPL": 80, "TRK": 50, "TI": 80}},
            "C": {"text": "Sensor inframerah yang dipakai saat gelap.", "bobot": {"SIKC": 40, "RPL": 50, "TRK": 80, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Dibuatkan folder berjenjang: Tahun > Mata Pelajaran > Tugas.", "bobot": {"SIKC": 80, "RPL": 60, "TRK": 40, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Mencari sumber berita asli dan data pembandingnya, lalu share.", "bobot": {"SIKC": 80, "RPL": 50, "TRK": 40, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Bagaimana mereka mengatur stok ribuan barang agar tidak habis.", "bobot": {"SIKC": 80, "RPL": 40, "TRK": 30, "TI": 50}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Membuat aplikasi sekolah untuk absen dan nilai.", "bobot": {"SIKC": 50, "RPL": 80, "TRK": 40, "TI": 70}},
            "C": {"text": "Mengevaluasi kurikulum agar lebih relevan dengan dunia kerja.", "bobot": {"SIKC": 80, "RPL": 40, "TRK": 30, "TI": 50}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Ruangan penuh layar monitor dan server.", "bobot": {"SIKC": 40, "RPL": 60, "TRK": 80, "TI": 70}},
    ...
    # SOAL 36-50 (Lanjutan untuk melengkapi 50 soal)
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Menentukan hipotesis (dugaan awal) dan variabel data yang akan diuji.", "bobot": {"SIKC": 80, "RPL": 60, "TRK": 30, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Data kecepatan respons dan tingkat kepuasan (rating) pelanggan.", "bobot": {"SIKC": 80, "RPL": 60, "TRK": 40, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Mencatat total belanja harian dan membandingkannya dengan anggaran mingguan.", "bobot": {"SIKC": 80, "RPL": 50, "TRK": 30, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Mencoba mencari pola dari data yang aneh itu, apakah ada kesamaan *input*.", "bobot": {"SIKC": 80, "RPL": 60, "TRK": 40, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Kecepatan update data kemacetannya yang *real-time*.", "bobot": {"SIKC": 80, "RPL": 50, "TRK": 50, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "C": {"text": "Memastikan setiap kereta berangkat dan tiba tepat waktu sesuai skema yang teratur.", "bobot": {"SIKC": 80, "RPL": 50, "TRK": 50, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Data panen, distribusi, dan permintaan cabai dari 3 bulan terakhir.", "bobot": {"SIKC": 80, "RPL": 40, "TRK": 30, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Menggambarkan urutan langkah/proses secara sistematis agar tidak ada yang terlewat.", "bobot": {"SIKC": 80, "RPL": 90, "TRK": 40, "TI": 90}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Mengelompokkan buku berdasarkan tema, penulis, dan tahun terbit.", "bobot": {"SIKC": 80, "RPL": 60, "TRK": 40, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Membandingkan data pemakaian listrik 6 bulan terakhir.", "bobot": {"SIKC": 80, "RPL": 50, "TRK": 30, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Sejarah, politik, atau ekonomi (data dan fakta).", "bobot": {"SIKC": 80, "RPL": 40, "TRK": 30, "TI": 50}},
            "C": {"text": "Cara merakit atau memperbaiki alat-alat elektronik.", "bobot": {"SIKC": 40, "RPL": 40, "TRK": 80, "TI": 60}},
            "D": {"text": "Matematika dan teori-teori fisika.", "bobot": {"SIKC": 60, "RPL": 50, "TRK": 40, "TI": 80}}
        }
    },
    {
        "kategori": "analisis",
        ...
        "pilihan": {
            ...
            "B": {"text": "Membaca data sensus penduduk dan menganalisis tren per tahun.", "bobot": {"SIKC": 80, "RPL": 50, "TRK": 30, "TI": 60}},
...
pengembangan_soal = [
    # SOAL 1-35 (Dikutip dari input Anda)
    {
        ...
        "pilihan": {
            "A": {"text": "Aplikasi pendeteksi lokasi barang yang hilang di kamar.", "bobot": {"SIKC": 50, "RPL": 40, "TRK": 80, "TI": 60}},
            "B": {"text": "Aplikasi yang bisa mengerjakan PR Matematika otomatis.", "bobot": {"SIKC": 50, "RPL": 60, "TRK": 40, "TI": 90}},
            "C": {"text": "Aplikasi 'Lemari Pintar' yang menyarankan outfit baju harian.", "bobot": {"SIKC": 60, "RPL": 80, "TRK": 30, "TI": 50}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Internetnya lemot (lag) terus.", "bobot": {"SIKC": 30, "RPL": 40, "TRK": 80, "TI": 60}},
            "B": {"text": "Tombol kontrolnya susah dipencet dan menunya membingungkan.", "bobot": {"SIKC": 40, "RPL": 80, "TRK": 30, "TI": 50}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Memilih kombinasi warna dan font yang menarik mata.", "bobot": {"SIKC": 40, "RPL": 80, "TRK": 30, "TI": 50}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "C": {"text": "Menghias dengan widget, tema, dan icon pack yang keren.", "bobot": {"SIKC": 40, "RPL": 80, "TRK": 30, "TI": 50}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Menulis langkah demi langkah: 'Maju 100m, belok kiri, lalu...'", "bobot": {"SIKC": 50, "RPL": 80, "TRK": 30, "TI": 90}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Membangun sesuatu dari nol sesuai imajinasi sendiri.", "bobot": {"SIKC": 50, "RPL": 80, "TRK": 50, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Memodifikasi resepnya: tambah garam, kurangi gula, coba lagi.", "bobot": {"SIKC": 40, "RPL": 80, "TRK": 30, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "C": {"text": "Tombol menunya jelas dan gampang dicari, tidak membingungkan.", "bobot": {"SIKC": 50, "RPL": 80, "TRK": 30, "TI": 50}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Merancang aturan main yang seru, adil, dan logis.", "bobot": {"SIKC": 50, "RPL": 80, "TRK": 30, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Ganti tampilan (tema) biar lebih enak dibaca dan modern.", "bobot": {"SIKC": 40, "RPL": 80, "TRK": 30, "TI": 50}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "C": {"text": "Logika: Jika ditekan lantai 5, tapi ada orang di lantai 3, mana dulu?", "bobot": {"SIKC": 50, "RPL": 80, "TRK": 40, "TI": 90}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Membuat skenario: 'Jika dia datang jam 7, kita A. Jika jam 8, kita B.'", "bobot": {"SIKC": 50, "RPL": 80, "TRK": 30, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Bagaimana cara membuat AI bisa 'belajar' sendiri (coding-nya).", "bobot": {"SIKC": 50, "RPL": 80, "TRK": 40, "TI": 90}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Mengatur alur cerita agar penonton penasaran dan terkejut (plot twist).", "bobot": {"SIKC": 50, "RPL": 80, "TRK": 30, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Membuat desain sablon yang unik dan kekinian di laptop.", "bobot": {"SIKC": 40, "RPL": 80, "TRK": 30, "TI": 50}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Puas banget, rasanya ingin cari teka-teki lain.", "bobot": {"SIKC": 50, "RPL": 80, "TRK": 40, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Terlalu banyak tombol yang tidak pernah dipakai (User Interface buruk).", "bobot": {"SIKC": 50, "RPL": 80, "TRK": 30, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Fitur 'Chat Otomatis' yang menerjemahkan bahasa asing driver-turis.", "bobot": {"SIKC": 50, "RPL": 80, "TRK": 40, "TI": 80}},
            "B": {"text": "Sistem bonus poin yang lebih adil.", "bobot": {"SIKC": 90, "RPL": 50, "TRK": 30, "TI": 60}},
            "C": {"text": "Helm pintar yang ada bluetooth-nya.", "bobot": {"SIKC": 30, "RPL": 50, "TRK": 80, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Mengeksplorasi apa saja yang baru dan membandingkan dengan yang lama.", "bobot": {"SIKC": 50, "RPL": 80, "TRK": 30, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "C": {"text": "Posisi colokan listrik.", "bobot": {"SIKC": 40, "RPL": 40, "TRK": 80, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Bisa menciptakan solusi baru yang belum terpikirkan orang lain.", "bobot": {"SIKC": 50, "RPL": 80, "TRK": 30, "TI": 70}},
            "B": {"text": "Tahu banyak informasi dan data.", "bobot": {"SIKC": 80, "RPL": 50, "TRK": 30, "TI": 60}},
            "C": {"text": "Bisa memperbaiki segala macam alat.", "bobot": {"SIKC": 30, "RPL": 40, "TRK": 80, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Membuat diagram alur cerita bercabang (Mind map).", "bobot": {"SIKC": 60, "RPL": 80, "TRK": 30, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Menggeser setiap huruf satu langkah (A jadi B, B jadi C).", "bobot": {"SIKC": 50, "RPL": 80, "TRK": 30, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Sangat membantu mata dan terlihat elegan (UX).", "bobot": {"SIKC": 50, "RPL": 80, "TRK": 40, "TI": 60}},
    ...
    # SOAL 36-50 (Lanjutan untuk melengkapi 50 soal)
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Akan dipakai, karena desainnya membuat nyaman.", "bobot": {"SIKC": 60, "RPL": 80, "TRK": 40, "TI": 50}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "C": {"text": "Langkah-langkah yang berurutan, jelas, dan mudah diikuti penonton.", "bobot": {"SIKC": 80, "RPL": 80, "TRK": 40, "TI": 90}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "D": {"text": "Diagram alir dan poin-poin singkat.", "bobot": {"SIKC": 90, "RPL": 80, "TRK": 40, "TI": 80}}
        }
    },
    {
        "kategori": "pengembangan",
        ...
        "pilihan": {
            "A": {"text": "Aturan permainan (mekanisme *game*) yang adil dan logis.", "bobot": {"SIKC": 60, "RPL": 80, "TRK": 40, "TI": 90}},
            "B": {"text": "Desain karakter dan *map* yang indah.", "bobot": {"SIKC": 40, "RPL": 90, "TRK": 30, "TI": 50}},
            "C": {"text": "Spesifikasi *server* yang kencang.", "bobot": {"SIKC": 50, "RPL": 40, "TRK": 80, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Warna, *font*, dan logo yang menarik.", "bobot": {"SIKC": 40, "RPL": 80, "TRK": 30, "TI": 50}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Tampilan aplikasi yang intuitif dan proses transaksi yang cepat.", "bobot": {"SIKC": 70, "RPL": 80, "TRK": 50, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Membuat resep baru yang belum pernah ada.", "bobot": {"SIKC": 50, "RPL": 80, "TRK": 40, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Mengurangi teks dan memperbanyak visualisasi/gambar.", "bobot": {"SIKC": 50, "RPL": 80, "TRK": 40, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Warna dan tata letak menu. (Desain UX/UI)", "bobot": {"SIKC": 50, "RPL": 80, "TRK": 40, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Mekanisme pengeluaran uang kembalian.", "bobot": {"SIKC": 40, "RPL": 50, "TRK": 80, "TI": 60}},
            "B": {"text": "Tombol-tombol pilihan produk dan layar instruksi.", "bobot": {"SIKC": 50, "RPL": 80, "TRK": 40, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Membuat media sosial yang desainnya menarik perhatian anak muda.", "bobot": {"SIKC": 40, "RPL": 80, "TRK": 30, "TI": 50}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Kecepatannya dalam merespons pertanyaan yang logis.", "bobot": {"SIKC": 70, "RPL": 80, "TRK": 40, "TI": 80}},
            ...
            "D": {"text": "Kemampuan *server*-nya untuk menjawab jutaan *chat*.", "bobot": {"SIKC": 40, "RPL": 50, "TRK": 80, "TI": 60}}
        }
    },
    {
        "kategori": "pengembangan",
        ...
        "pilihan": {
            "A": {"text": "Warna yang cerah dan gambar yang lucu.", "bobot": {"SIKC": 40, "RPL": 80, "TRK": 30, "TI": 50}},
...
hardware_soal = [
    # SOAL 1-35 (Dikutip dari input Anda)
    {
        ...
        "pilihan": {
            "A": {"text": "Melihat lampu indikator di modem/router, nyala atau kedip?", "bobot": {"SIKC": 40, "RPL": 40, "TRK": 80, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Memasang baut dan menyambungkan kaki meja sampai kokoh.", "bobot": {"SIKC": 30, "RPL": 40, "TRK": 80, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Keren, seperti di film sci-fi! Ingin tahu kabel ini ke mana saja.", "bobot": {"SIKC": 40, "RPL": 40, "TRK": 80, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Matikan, bongkar casing/baterai, lalu kubur di beras (keringkan).", "bobot": {"SIKC": 40, "RPL": 50, "TRK": 80, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Membeli alat penguat sinyal (Repeater/Extender) dan memasangnya.", "bobot": {"SIKC": 50, "RPL": 50, "TRK": 80, "TI": 75}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Prosesor dan RAM-nya (Kecepatan mesin).", "bobot": {"SIKC": 50, "RPL": 70, "TRK": 80, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Memilihkan komponen yang kompatibel (Cek soket prosesor, jenis RAM).", "bobot": {"SIKC": 50, "RPL": 50, "TRK": 80, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Teknologi baterai dan motor penggeraknya canggih.", "bobot": {"SIKC": 50, "RPL": 50, "TRK": 80, "TI": 70}},
            "B": {"text": "Sistem autopilot (nyetir sendiri)-nya keren.", "bobot": {"SIKC": 60, "RPL": 80, "TRK": 50, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Rapi, kabel diikat pakai 'cable ties' atau velkro.", "bobot": {"SIKC": 50, "RPL": 50, "TRK": 80, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Cek sekring/MCB meteran listrik, coba nyalakan lagi.", "bobot": {"SIKC": 40, "RPL": 40, "TRK": 80, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Motor baling-baling dan keseimbangan terbangnya.", "bobot": {"SIKC": 40, "RPL": 40, "TRK": 80, "TI": 60}},
            "B": {"text": "Program remote control dan fitur 'pulang otomatis'.", "bobot": {"SIKC": 50, "RPL": 80, "TRK": 50, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Gedung besar penuh harddisk yang menyala 24 jam di suatu tempat.", "bobot": {"SIKC": 50, "RPL": 50, "TRK": 80, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Mungkin kotor atau pelumasnya habis (masalah mekanik).", "bobot": {"SIKC": 40, "RPL": 40, "TRK": 80, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Rumit juga ya menyambung kabel serat optik (fiber) itu.", "bobot": {"SIKC": 40, "RPL": 40, "TRK": 80, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "SSD (Storage) biar booting/loading super cepat.", "bobot": {"SIKC": 50, "RPL": 70, "TRK": 80, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Klik 'Eject' atau 'Safely Remove' dulu.", "bobot": {"SIKC": 60, "RPL": 60, "TRK": 80, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Mengatur agar suaranya tidak mendengung (feedback) dan jernih.", "bobot": {"SIKC": 40, "RPL": 40, "TRK": 80, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Kesehatan kimiawi baterainya menurun (Cycle count).", "bobot": {"SIKC": 50, "RPL": 50, "TRK": 80, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Melindungi fisik HP dari benturan keras.", "bobot": {"SIKC": 40, "RPL": 40, "TRK": 80, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Membongkarnya, ingin lihat isinya (kanibalan komponen).", "bobot": {"SIKC": 40, "RPL": 40, "TRK": 80, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Transistor/Prosesor (Otak komputer mikro).", "bobot": {"SIKC": 50, "RPL": 60, "TRK": 80, "TI": 85}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Cek kabel VGA/HDMI-nya, goyang-goyangkan sedikit.", "bobot": {"SIKC": 40, "RPL": 40, "TRK": 80, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Kabel, karena responsnya lebih cepat (zero latency) buat gaming.", "bobot": {"SIKC": 40, "RPL": 60, "TRK": 80, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Bagaimana cara menyusun kerangka besinya agar bisa jalan.", "bobot": {"SIKC": 30, "RPL": 30, "TRK": 80, "TI": 60}},
            "B": {"text": "Bagaimana coding AI-nya agar dia pintar.", "bobot": {"SIKC": 50, "RPL": 80, "TRK": 40, "TI": 80}},
    ...
    # SOAL 36-50 (Lanjutan untuk melengkapi 50 soal)
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Menggunakan alat ukur (multimeter) untuk cek arus dan tegangan tiap kabel.", "bobot": {"SIKC": 60, "RPL": 50, "TRK": 80, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Mengecek kabel power, monitor, dan menekan tombol *reset*.", "bobot": {"SIKC": 40, "RPL": 40, "TRK": 80, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Di tengah rumah, di tempat tinggi, dan jauh dari tembok beton.", "bobot": {"SIKC": 70, "RPL": 60, "TRK": 80, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Agar tahan banting/rusak dan sulit dibobol.", "bobot": {"SIKC": 60, "RPL": 50, "TRK": 80, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Menghitung dan merakit komponen *chip* di dalamnya agar listriknya stabil.", "bobot": {"SIKC": 50, "RPL": 60, "TRK": 80, "TI": 90}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Memotong bagian yang terkelupas dan menyambungnya kembali dengan benar.", "bobot": {"SIKC": 50, "RPL": 50, "TRK": 80, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Kapasitas (mAh) dan fitur *fast charging*.", "bobot": {"SIKC": 70, "RPL": 60, "TRK": 80, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Membuat *hardware*-nya bisa menyala 24 jam nonstop (Tahan panas).", "bobot": {"SIKC": 60, "RPL": 50, "TRK": 80, "TI": 70}},
            ...
            "D": {"text": "Merekam semua data aktivitas pengunjung *website*.", "bobot": {"SIKC": 80, "RPL": 50, "TRK": 40, "TI": 60}}
        }
    },
    {
        "kategori": "hardware",
        ...
        "pilihan": {
            ...
            "B": {"text": "Akurasi sensor kesehatan (detak jantung, oksigen).", "bobot": {"SIKC": 70, "RPL": 60, "TRK": 80, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "*Speaker* aktif punya amplifier (penguat suara) di dalamnya.", "bobot": {"SIKC": 60, "RPL": 50, "TRK": 80, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Semua kabel sudah tertancap dengan rapi dan benar.", "bobot": {"SIKC": 50, "RPL": 50, "TRK": 80, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Desainnya yang rumit dan kecil.", "bobot": {"SIKC": 40, "RPL": 80, "TRK": 80, "TI": 70}},
            "B": {"text": "Bisa menyimpan data sebanyak itu.", "bobot": {"SIKC": 90, "RPL": 50, "TRK": 70, "TI": 60}},
            "C": {"text": "Kecepatannya memproses triliunan data per detik.", "bobot": {"SIKC": 60, "RPL": 70, "TRK": 80, "TI": 90}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Presisi pergerakan sendi robotnya.", "bobot": {"SIKC": 50, "RPL": 60, "TRK": 80, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "C": {"text": "Untuk menambal kelemahan keamanan jaringan yang sudah ditemukan.", "bobot": {"SIKC": 80, "RPL": 60, "TRK": 80, "TI": 80}},
...
logika_soal = [
    # SOAL 1-50 (Lengkap)
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Membuat tumpukan: ambil 1 bola, bandingkan dengan tumpukan terakhir, dan masukkan di tempatnya.", "bobot": {"SIKC": 70, "RPL": 60, "TRK": 50, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Memprediksi 5-6 langkah ke depan yang mungkin dilakukan lawan.", "bobot": {"SIKC": 80, "RPL": 70, "TRK": 50, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Kombinasi acak: huruf besar, kecil, angka, dan simbol.", "bobot": {"SIKC": 80, "RPL": 70, "TRK": 90, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Rute terpendek yang menghubungkan semua alamat (Masalah *Travelling Salesman*).", "bobot": {"SIKC": 90, "RPL": 85, "TRK": 60, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Timbangan bahan yang presisi dan urutan langkah yang benar.", "bobot": {"SIKC": 80, "RPL": 90, "TRK": 60, "TI": 80}},
            "C": {"text": "Tampilan kuenya setelah matang.", "bobot": {"SIKC": 50, "RPL": 80, "TRK": 40, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Desain tampilannya.", "bobot": {"SIKC": 40, "RPL": 80, "TRK": 40, "TI": 60}},
            "B": {"text": "Membuatnya bisa menghitung operasi yang rumit (Order of Operations).", "bobot": {"SIKC": 70, "RPL": 80, "TRK": 50, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "C": {"text": "Membuat diagram alir untuk memastikan alur logikanya benar.", "bobot": {"SIKC": 90, "RPL": 80, "TRK": 70, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Membuat aturan yang mudah diingat tapi susah dipecahkan orang lain.", "bobot": {"SIKC": 70, "RPL": 90, "TRK": 50, "TI": 80}},
            "B": {"text": "Memastikan alat kirim sandi (senter/radio) berfungsi baik.", "bobot": {"SIKC": 40, "RPL": 40, "TRK": 80, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Sudut dan timing pengereman di tikungan (fisika/algoritma).", "bobot": {"SIKC": 80, "RPL": 90, "TRK": 70, "TI": 80}},
            "C": {"text": "Tampilan *custom* mobilmu.", "bobot": {"SIKC": 40, "RPL": 80, "TRK": 40, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Kesalahan-kesalahan kecil (lubang plot) yang tidak logis.", "bobot": {"SIKC": 80, "RPL": 80, "TRK": 50, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Menerapkan rumus fisika dasar (jarak = kecepatan x waktu).", "bobot": {"SIKC": 80, "RPL": 60, "TRK": 60, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Memahami sistem keamanan dan kelemahan logikanya.", "bobot": {"SIKC": 80, "RPL": 90, "TRK": 80, "TI": 80}},
            "C": {"text": "Akses internet yang super cepat.", "bobot": {"SIKC": 50, "RPL": 60, "TRK": 80, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Kerangka badan robot dari besi.", "bobot": {"SIKC": 40, "RPL": 40, "TRK": 80, "TI": 60}},
            "B": {"text": "Alur perintah (logika) agar robot tahu apa yang harus dilakukan (misal: maju, mundur).", "bobot": {"SIKC": 70, "RPL": 90, "TRK": 60, "TI": 80}},
            "C": {"text": "Desain luar robot agar terlihat keren.", "bobot": {"SIKC": 40, "RPL": 80, "TRK": 40, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Melatih otak untuk berpikir logis dan sistematis.", "bobot": {"SIKC": 80, "RPL": 80, "TRK": 60, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Membuat lampu yang bisa memprioritaskan jalan terpadat (algoritma *real-time*).", "bobot": {"SIKC": 90, "RPL": 80, "TRK": 60, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Menggunakan kunci enkripsi yang kompleks (misal: pergeseran huruf yang berubah-ubah).", "bobot": {"SIKC": 80, "RPL": 90, "TRK": 70, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Membuat matriks prioritas (Penting vs Mendesak) untuk urutan kerja.", "bobot": {"SIKC": 80, "RPL": 80, "TRK": 50, "TI": 90}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Mengidentifikasi pola dan bentuk lubang yang harus diisi.", "bobot": {"SIKC": 80, "RPL": 90, "TRK": 50, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Ada *bug* (kesalahan) di dalam alur perintah (*coding*) program itu.", "bobot": {"SIKC": 80, "RPL": 80, "TRK": 60, "TI": 80}},
            "C": {"text": "Suhu *laptop* terlalu panas.", "bobot": {"SIKC": 50, "RPL": 60, "TRK": 80, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Data statistik untung/rugi perusahaan 10 tahun terakhir.", "bobot": {"SIKC": 80, "RPL": 40, "TRK": 40, "TI": 80}},
            "C": {"text": "Menggunakan rumus matematika/prediksi untuk melihat tren kenaikan/penurunan.", "bobot": {"SIKC": 90, "RPL": 70, "TRK": 50, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Mencari tahu langkah (proses) mana yang paling memakan waktu.", "bobot": {"SIKC": 90, "RPL": 80, "TRK": 60, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Menggambar peta agar terlihat indah.", "bobot": {"SIKC": 40, "RPL": 80, "TRK": 40, "TI": 50}},
            "B": {"text": "Membuat petunjuk yang logis, tapi butuh pemecahan masalah untuk sampai ke sana.", "bobot": {"SIKC": 80, "RPL": 90, "TRK": 50, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Membuat aplikasi yang mencatat kehadiran setiap hari dan menghitung persentase otomatis.", "bobot": {"SIKC": 80, "RPL": 90, "TRK": 50, "TI": 90}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Membuat desain grafis yang realistis.", "bobot": {"SIKC": 40, "RPL": 80, "TRK": 50, "TI": 60}},
            "B": {"text": "Membuat *Artificial Intelligence* (AI) musuh yang pintar dan tidak mudah dikalahkan.", "bobot": {"SIKC": 80, "RPL": 85, "TRK": 60, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Membuat daftar pro dan kontra, memberi bobot nilai pada setiap aspek, lalu menghitung hasilnya.", "bobot": {"SIKC": 80, "RPL": 80, "TRK": 50, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Mengombinasikan *skill* dan *item* agar menghasilkan damage maksimal.", "bobot": {"SIKC": 70, "RPL": 85, "TRK": 50, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Mengaplikasikan urutan operasi yang benar (kali/bagi dulu, baru tambah/kurang).", "bobot": {"SIKC": 80, "RPL": 70, "TRK": 60, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Menggunakan data rekaman video *real-time* untuk keputusan.", "bobot": {"SIKC": 80, "RPL": 70, "TRK": 80, "TI": 90}},
            "B": {"text": "Memastikan penonton mendukung keputusanmu.", "bobot": {"SIKC": 40, "RPL": 40, "TRK": 40, "TI": 40}},
            "C": {"text": "Memastikan alat komunikasi dengan asisten wasit berjalan baik.", "bobot": {"SIKC": 60, "RPL": 50, "TRK": 80, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "C": {"text": "Karena menggunakan algoritma kompleks untuk mengurutkan relevansi data.", "bobot": {"SIKC": 80, "RPL": 80, "TRK": 60, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Membuat sistem penamaan dan penempatan barang yang teratur (indeks).", "bobot": {"SIKC": 80, "RPL": 70, "TRK": 60, "TI": 90}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Urutan langkah 1, 2, 3 yang logis dan jelas.", "bobot": {"SIKC": 90, "RPL": 80, "TRK": 70, "TI": 80}},
            "C": {"text": "Membaca *review* dari orang yang sudah merakit.", "bobot": {"SIKC": 70, "RPL": 60, "TRK": 50, "TI": 70}},
            "D": {"text": "Alat-alat yang lengkap.", "bobot": {"SIKC": 40, "RPL": 40, "TRK": 80, "TI": 60}}
        }
    },
    {
        "kategori": "logika",
        ...
        "pilihan": {
            ...
            "B": {"text": "Memasukkan rumus (*formula*) dan fungsi statistik yang benar.", "bobot": {"SIKC": 90, "RPL": 85, "TRK": 50, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Alur pemecahan masalahnya yang butuh langkah-langkah panjang dan terperinci.", "bobot": {"SIKC": 70, "RPL": 90, "TRK": 50, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Bagaimana rangkaian listriknya bisa dibuat berkedip dengan pola tertentu.", "bobot": {"SIKC": 70, "RPL": 80, "TRK": 80, "TI": 90}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Membuat sistem klasifikasi yang rinci dan tidak ambigu (Logika Boolean).", "bobot": {"SIKC": 90, "RPL": 80, "TRK": 60, "TI": 80}},
            "C": {"text": "Membuat desain keranjang cucian yang banyak.", "bobot": {"SIKC": 40, "RPL": 80, "TRK": 40, "TI": 60}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Mencari pola angka yang tersembunyi.", "bobot": {"SIKC": 80, "RPL": 70, "TRK": 50, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Menggunakan algoritma: terdekat dari driver + skor *rating* driver + rute terpendek.", "bobot": {"SIKC": 80, "RPL": 90, "TRK": 60, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Koneksi internet tiba-tiba mati.", "bobot": {"SIKC": 40, "RPL": 40, "TRK": 80, "TI": 60}},
            ...
            "D": {"text": "*Skill* karakter yang *bug* (tidak bekerja).", "bobot": {"SIKC": 50, "RPL": 90, "TRK": 60, "TI": 80}}
        }
    },
    {
        "kategori": "logika",
        ...
        "pilihan": {
            "A": {"text": "Kualitas sensor gerak (akselerometer) agar presisi.", "bobot": {"SIKC": 70, "RPL": 80, "TRK": 80, "TI": 90}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Menerapkan sistem antrean tunggal yang bercabang ke banyak teller.", "bobot": {"SIKC": 90, "RPL": 70, "TRK": 50, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Kemampuan membuat rumus matematika yang kompleks.", "bobot": {"SIKC": 80, "RPL": 70, "TRK": 50, "TI": 80}},
            "C": {"text": "Bisa untuk membuat laporan data keuangan.", "bobot": {"SIKC": 80, "RPL": 50, "TRK": 40, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Apakah ada *bug* atau celah yang bisa merusak alur permainan (logika *game*).", "bobot": {"SIKC": 80, "RPL": 80, "TRK": 60, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Menjumlahkan semua nilai teman, lalu dibagi jumlah siswa.", "bobot": {"SIKC": 80, "RPL": 70, "TRK": 50, "TI": 90}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Membuat data jalan (*routing*) yang akurat dan selalu *update*.", "bobot": {"SIKC": 90, "RPL": 80, "TRK": 60, "TI": 80}},
            "C": {"text": "Memastikan servernya tidak *down*.", "bobot": {"SIKC": 60, "RPL": 50, "TRK": 80, "TI": 70}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Korelasi sebab-akibat antar kejadian secara berurutan.", "bobot": {"SIKC": 80, "RPL": 80, "TRK": 50, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            "A": {"text": "Motor penggeraknya yang cepat.", "bobot": {"SIKC": 40, "RPL": 50, "TRK": 80, "TI": 60}},
            "B": {"text": "Strategi (*decision making*) robot saat mengoper dan menembak bola.", "bobot": {"SIKC": 80, "RPL": 90, "TRK": 60, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Menghitung diskon pertama, lalu sisa harga didiskon lagi (logika urutan).", "bobot": {"SIKC": 90, "RPL": 70, "TRK": 50, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Menganalisis data pola suhu, tekanan udara, dan kelembaban 7 hari terakhir.", "bobot": {"SIKC": 80, "RPL": 60, "TRK": 50, "TI": 90}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Membuat *database* untuk menyimpan data.", "bobot": {"SIKC": 80, "RPL": 70, "TRK": 60, "TI": 80}},
            "C": {"text": "Menulis algoritma *IF-THEN-ELSE* yang sangat panjang dan bertingkat.", "bobot": {"SIKC": 80, "RPL": 80, "TRK": 50, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "B": {"text": "Membuat alur logika lebih mudah dipahami manusia sebelum diterjemahkan ke bahasa mesin.", "bobot": {"SIKC": 90, "RPL": 80, "TRK": 50, "TI": 80}},
    ...
    },
    {
        ...
        "pilihan": {
            ...
            "C": {"text": "Pola dan waktu munculnya *virus* baru di dunia.", "bobot": {"SIKC": 90, "RPL": 80, "TRK": 70, "TI": 80}},
